...
const UsersComponent = styled.div<{ themes: boolean }>`
  display: flex;
  column-gap: 38px;
  max-width: 730px;
  padding: 44px 48px;
  ...
  background: ${(props) =>
    props.themes ? "rgb(254, 254, 254)" : "rgb(30, 42, 71)"};
      ...
      .user {
        .userName-joined {
          ...
          .userName-id {
            ...
            p {
              color: ${(props) =>
                props.themes ? "rgb(43, 52, 66)" : "rgb(255, 255, 255)"};
              font-size: 26px;
              font-weight: 700;
              line-height: 39px;
          ...
          .userJoined {
            color: ${(props) =>
              props.themes ? " rgb(105, 124, 154)" : "rgb(255, 255, 255)"};
            font-size: 15px;
            font-weight: 400;
            line-height: 30px;
          }
    ...
    .userAdresse {
      ...
      ul {
        ...
        li {
          ...
          svg path {
            fill: ${(props) => (props.themes ? "" : "rgb(255, 255, 255)")};
          }
